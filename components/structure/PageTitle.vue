...
<style lang="scss" scoped>
    [glitch] {
        ...
        &:after{
            ...
            text-shadow: calc(var(--left) * -3em) 0 0.02em theme("colors.green.400"), calc(var(--left) * -6em) 0 0.02em theme("colors.fuchsia.500");
        ...
        &:after{
            animation: glitch-a .75s infinite alternate;
        }
    }
